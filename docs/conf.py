...
project = u'AiiDA Wannier90 Tutorial (2020)'
# pylint: disable=redefined-builtin
copyright = u'\
2020, ECOLE POLYTECHNIQUE FEDERALE DE LAUSANNE (Theory and Simulation of Materials (THEOS), Switzerland. All rights reserved'
...
latex_documents = [
    ('index', 'aiida-tutorials.tex', u'AiiDA Wannier90 Tutorial (2020)',
...
man_pages = [('index', 'aiida', u'AiiDA Wannier90 Tutorial (2020)', [author], 1)]
...
texinfo_documents = [
    ('index', 'aiida-tutorials', u'AiiDA Wannier90 Tutorial (2020)', author, 'aiida-tutorials',
     'Tutorials and demos for AiiDA and Wannier90', 'Miscellaneous'),
]
...
epub_title = u'AiiDA-Wannier90 Tutorial (2020'
epub_author = author
